...
export function Header() {
  ...
  if (page === 'Comunidade') {
    return (
      <div
        className={`flex flex-col items-start gap-2.5 self-stretch py-2 px-3 border border-[#ececec] bg-neutral-50 ${
          !isMobileDevice() && 'sticky z-[99] top-0'
        }`}
      >
        <div className="flex justify-between items-center self-stretch py-0 px-1">
